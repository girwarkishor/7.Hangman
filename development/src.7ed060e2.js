...
},{"../internals/to-integer":"../node_modules/core-js-pure/internals/to-integer.js"}],"../node_modules/core-js-pure/internals/to-length.js":[function(require,module,exports) {
var toInteger = require('../internals/to-integer');
...
},{"../internals/to-integer":"../node_modules/core-js-pure/internals/to-integer.js"}],"../node_modules/core-js-pure/internals/to-object.js":[function(require,module,exports) {
var requireObjectCoercible = require('../internals/require-object-coercible');
...
},{"../internals/descriptors":"../node_modules/core-js-pure/internals/descriptors.js","../internals/fails":"../node_modules/core-js-pure/internals/fails.js","../internals/has":"../node_modules/core-js-pure/internals/has.js"}],"../node_modules/core-js-pure/modules/es.array.splice.js":[function(require,module,exports) {
'use strict';
...
},{"../internals/path":"../node_modules/core-js-pure/internals/path.js"}],"../node_modules/core-js-pure/es/array/virtual/splice.js":[function(require,module,exports) {
...
},{"core-js-pure/stable/instance/splice":"../node_modules/core-js-pure/stable/instance/splice.js"}],"../node_modules/core-js-pure/modules/web.timers.js":[function(require,module,exports) {
...
},{"core-js-pure/stable/set-timeout":"../node_modules/core-js-pure/stable/set-timeout.js"}],"../node_modules/core-js-pure/internals/add-to-unscopables.js":[function(require,module,exports) {
...
},{"core-js-pure/stable/instance/for-each":"../node_modules/core-js-pure/stable/instance/for-each.js"}],"../node_modules/core-js-pure/modules/es.array.concat.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var fails = require('../internals/fails');
var isArray = require('../internals/is-array');
...
},{"core-js-pure/stable/instance/concat":"../node_modules/core-js-pure/stable/instance/concat.js"}],"../node_modules/core-js-pure/modules/es.array.includes.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
...
},{"core-js-pure/stable/instance/includes":"../node_modules/core-js-pure/stable/instance/includes.js"}],"../node_modules/core-js-pure/modules/es.array.map.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
...
},{"core-js-pure/stable/instance/map":"../node_modules/core-js-pure/stable/instance/map.js"}],"C:/Users/girwa/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
function displayWord() {
  ...
  wordEl.innerHTML = "\n     ".concat((0, _map.default)(_context = selectedWord.split("")).call(_context, function (letter) {
    return "\n                <span class=\"letter\">\n                    ".concat((0, _includes.default)(correctLetters).call(correctLetters, letter) ? letter : "", "\n                </span>\n            ");
  }).join(""), "\n    ");
  var innerWord = wordEl.innerText.replace(/\n/g, ""); //   console.log(wordEl.innerText, innerWord);
...
function updateWrongLetterEl() {
  ...
  wrongLettersEl.innerHTML = (0, _concat.default)(_context2 = "\n    ".concat(wrongLetters.length > 0 ? "<p>Wrong</p>" : "", "\n    ")).call(_context2, (0, _map.default)(wrongLetters).call(wrongLetters, function (letter) {
    return "<span>".concat(letter, "</span>");
  }), "\n");
  (0, _forEach.default)(figureParts).call(figureParts, function (part, index) {
...
window.addEventListener("keydown", function (e) {
  ...
  if (e.keyCode >= 65 && e.keyCode <= 90) {
    ...
    if ((0, _includes.default)(selectedWord).call(selectedWord, letter)) {
      if (!(0, _includes.default)(correctLetters).call(correctLetters, letter)) {
      ...
      if (!(0, _includes.default)(wrongLetters).call(wrongLetters, letter)) {
...
playAgainBtn.addEventListener("click", function () {
  // Empty arrays
  (0, _splice.default)(correctLetters).call(correctLetters, 0);
  (0, _splice.default)(wrongLetters).call(wrongLetters, 0);
...
displayWord();
},{"@babel/runtime-corejs3/core-js-stable/instance/splice":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/splice.js","@babel/runtime-corejs3/core-js-stable/set-timeout":"../node_modules/@babel/runtime-corejs3/core-js-stable/set-timeout.js","@babel/runtime-corejs3/core-js-stable/instance/for-each":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/for-each.js","@babel/runtime-corejs3/core-js-stable/instance/concat":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/concat.js","@babel/runtime-corejs3/core-js-stable/instance/includes":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/includes.js","@babel/runtime-corejs3/core-js-stable/instance/map":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/map.js","./scss/main.scss":"../src/scss/main.scss"}],"C:/Users/girwa/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
